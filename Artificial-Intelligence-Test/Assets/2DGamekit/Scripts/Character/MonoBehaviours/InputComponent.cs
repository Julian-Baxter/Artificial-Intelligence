...
namespace Gamekit2D
{
    public abstract class InputComponent : MonoBehaviour
    {
        ...
        public class InputButton
        {
            ...
            public ArtificialButtons artButton = ArtificialButtons.None;
            ...
            protected static readonly  Dictionary<int, string> a_ButtonsToName = new Dictionary<int, string> {
            ...
            public InputButton(KeyCode key, XboxControllerButtons controllerButton, ArtificialButtons artButton)
            {
                this.key = key;
                this.controllerButton = controllerButton;
                this.artButton = artButton;
            }
            ...
            public void Get(bool fixedUpdateHappened, InputType inputType)
            {
                ...
                if (inputType == InputType.Controller)
                {
                    ...
                    {
                        Debug.Log("New Fixed Update! Button Checked: " + controllerButton +"; Getting the String: "+ k_ButtonsToName[(int)controllerButton]+";");
                    ...
                    if (Down == true)
                    {
                        Debug.Log(controllerButton + ": Down;");
                    }
                    if (Held == true)
                    {
                        Debug.Log(controllerButton + ": Held;");
                    }
                    if (Up == true)
                    {
                        Debug.Log(controllerButton + ": Up;");
                    }
                }
                else if (inputType == InputType.MouseAndKeyboard)
                {
                    if (fixedUpdateHappened)
                    {
                        Debug.Log("New Fixed Update! Key Checked: "+key);
                ...
                else if (inputType == InputType.ArtificialOutput)
                {
                    if (fixedUpdateHappened)
                    {
                        Down = OutputProcessor.GetKeyDown(a_ButtonsToName[(int)artButton]);
                        Held = OutputProcessor.GetKey(a_ButtonsToName[(int)artButton]);
                        Up = OutputProcessor.GetKeyUp(a_ButtonsToName[(int)artButton]);
                    ...
                    {
                        Down = OutputProcessor.GetKeyDown(a_ButtonsToName[(int)artButton]) || m_AfterFixedUpdateDown;
                        Held = OutputProcessor.GetKey(a_ButtonsToName[(int)artButton]) || m_AfterFixedUpdateUp;
                        Up = OutputProcessor.GetKeyUp(a_ButtonsToName[(int)artButton]) || m_AfterFixedUpdateUp;
        ...
        public class InputAxis
        {
            ...
            public ArtificialAxes artNegative;
            public ArtificialAxes artPositive;
            ...
            public InputAxis(KeyCode positive, KeyCode negative, XboxControllerAxes controllerAxis, ArtificialAxes artPositive, ArtificialAxes artNegative)
            {
                this.positive = positive;
                this.negative = negative;
                this.controllerAxis = controllerAxis;
                this.artPositive = artPositive;
                this.artNegative = artNegative;
            }
            ...
            public void Get(InputType inputType)
            {
                ...
                /*else if(inputType == InputType.ArtificialOutput)
                {
//                    positiveHeld = OutputProcessor.GetKey(a_AxisToName[(int)artPositive]);
//                    negativeHeld = Input.GetButtonDown(a_AxisToName[(int)artNegative]);
                }*/
